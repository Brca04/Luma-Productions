...
export const metadata: Metadata = {
  title: 'Fotografija Svetog Krštenja',
  description:
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-10 lg:gap-20 mb-16">
          ...
          <div className="max-w-2xl lg:pt-2">
            <p className="text-lg text-gray-600 leading-[1.8] font-light">
              Odaberite paket prema opsegu pokrivenosti. Sve cijene uključuju
              obradu fotografija i online galeriju. Dodatni sati i tiskani
              albumi dostupni su na upit.
            </p>
          </div>
        </div>
